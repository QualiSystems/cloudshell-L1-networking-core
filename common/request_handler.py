...
class RequestHandler:
    ...
    def set_speed_manual(self, command_node, xs_prefix='', command_logger=None):
       ...
       """
        ...
        response = self._driver_handler.set_speed_manual(src_port.split('/'), dst_port.split('/'), speed, duplex, command_logger)
        return response
    ...
    def get_attribute_value(self, command_node, xs_prefix='', command_logger=None):
        ...
        addr_str  = XMLWrapper.get_node_text(XMLWrapper.get_child_node(parameters_node, 'Address', xs_prefix))
        attr_str = XMLWrapper.get_node_text(XMLWrapper.get_child_node(parameters_node, 'Attribute', xs_prefix))

        response = self._driver_handler.get_attribute_value(addr_str, attr_str, command_logger)
        return response